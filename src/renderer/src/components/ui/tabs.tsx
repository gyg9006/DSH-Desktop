...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn('inline-flex items-center justify-center rounded-lg border border-cyber-border bg-cyber-panel2 p-1 text-cyber-dim', className)}
    {...props}
  />
))
